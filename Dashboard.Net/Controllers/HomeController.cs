...
namespace Dashboard.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Index(ProjectViewModel model,string command)
        {
            try
            {
                if (command == "Add")
                ...
                else if (command == "Create")
                {
                    ...
                    return View("CustomError",new CustomErrorViewModel {  Title="Complete", Subtitle="Project successfully created", Description="Your project was successfully created and welcome emails sent to the team members.",  CallToAction="Create another project...", ActionText="Continue", ActionUrl=Request.Url.ToString()});
                }
            }
            catch (Exception ex)
            {
