...
namespace Dashboard.Webjobs.Net
{
    ...
    public class Program
    {
        ...
        public static IClassQueue CacheQueue;
        public static IClassQueue StorageQueue;
        public static IClassQueue SqlQueue;
        ...
        static void Main()
        {
            ...
            CacheQueue = ContainerIOC.ResolveKeyed<IClassQueue>(Queuenames.CreateCache);
            StorageQueue = ContainerIOC.ResolveKeyed<IClassQueue>(Queuenames.CreateStorage);
            SqlQueue = ContainerIOC.ResolveKeyed<IClassQueue>(Queuenames.CreateSql);
        ...
        public static IContainer BuildContainerIoC()
        {
            ...
            builder.Register(g => new AzureClassQueue(AppSettings.AzureStorageConnectionString, Queuenames.CreateCache)).Keyed<IClassQueue>(Queuenames.CreateCache);
            builder.Register(g => new AzureClassQueue(AppSettings.AzureStorageConnectionString, Queuenames.CreateStorage)).Keyed<IClassQueue>(Queuenames.CreateStorage);
            builder.Register(g => new AzureClassQueue(AppSettings.AzureStorageConnectionString, Queuenames.CreateSql)).Keyed<IClassQueue>(Queuenames.CreateSql);
